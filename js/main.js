...
{id: 4, 
    dataItem:'app',
    imgSrc: "./assets/images/e-commerce-thumbnail.png", 
    header: 'React.js App', 
    subHead:"E-Commerce Store",
    category: 'React.js App',
    description: 'E-Commerce Store',
    descriptOne: 'Products integrated through Chec.io API, complete with custom forms that take you through Sign In/Create Account, Shopping Cart, Shipping, Payment, and Confirmation.', 
...
{id: 12, 
    dataItem:'web',
    imgSrc: "./assets/images/blog-thumbnail.png", 
    header: 'WordPress Project', 
    subHead:"Health Blog",
    category: 'WordPress Project',
    description: 'Health Food Blog',
    descriptOne: 'This blog is built with WordPress & Elementor, complete with CMS editing, categories, and related blog sections. Fully Responsive', 
    descriptTwo:`<a target='_blank' href='https://samelder.coach/'> Check it out Here </a>` , 
    dataOpen: 'web-5' },
{id: 9, 
    dataItem:'web',
...
{id: 11, 
    ...
    descriptOne: 'This project is a simple, minimal, functional calculator. Project is built with HTML, CSS, JavaScript, jQuery', 
